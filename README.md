...
- Завантаження хвилинних даних для нових лістингів (перші 48 годин)

Скрипт спочатку намагається отримати дату лістингу з поля `onboardDate` у `exchangeInfo`. Якщо цього поля немає або воно дорівнює нулю, виконується сканування денних та годинних свічок для пошуку першої активної торгівлі. Після визначення моменту лістингу колектор завантажує рівно 48 годин хвилинних даних, починаючи з цієї позначки часу.
